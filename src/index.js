window.show = show;
window.fullDump = fullDump;
window.outFullDump = outFullDump;
window.halfDump = halfDump;
window.outHalfDump = outHalfDump;
window.addEmployee = addEmployee;
window.addToEmployees = addToEmployees;
window.checkEmpCode = checkEmpCode;
window.fnFilter = fnFilter;
window.filterByBoth = filterByBoth;
window.filterByDept = filterByDept;
window.filterByDesig = filterByDesig;
window.edit = edit;
window.editedEmployees = editedEmployees;
window.byEmpcode = byEmpcode;
window.compareEmpcode = compareEmpcode;
window.byName = byName;
window.compareName = compareName;
window.byAge = byAge;
window.compareAge = compareAge;
window.byGender = byGender;
window.compareGender = compareGender;
window.byDepartment = byDepartment;
window.compareDepartment = compareDepartment;
window.byDesignation = byDesignation;
window.compareDesignation = compareDesignation;
window.bySalary = bySalary;
window.compareSalary = compareSalary;
...
function addEmployee() {
  ...
  departmentInput.innerHTML =
    "<option selected disabled value='notSelected'>Choose Department</option><option>Finance</option><option>Technology</option><option>Marketing</option><option>Operations</option>";
  ...
  designationInput.innerHTML =
    "<option selected disabled value='notSelected'>Choose Designation</option><option>Trainee</option><option>Manager</option><option>Vice President</option><option>President</option>";
...
function fnFilter() {
  ...
  if (valDesig == "notSelected" && valDept == "notSelected") show(Employees);
    ...
    var filteredEmployees = Employees.filter((n) =>
      filterByBoth(n, valDept, valDesig)
    );
...
function filterByDept(n, dept) {
  if (n.department == dept) return true;
  else return false;
}

function filterByDesig(n, desig) {
  if (n.designation == desig) return true;
  else return false;
}

function filterByBoth(n, dept, desig) {
  if (n.department == dept && n.designation == desig) return true;
  else return false;
}
...
function show() {
  let form =
    "<div>Filter Employees By" +
    "<select id='filterDept'><option selected value='notSelected'>Choose Department</option><option>Finance</option><option>Technology</option><option>Marketing</option><option>Operations</option></select>" +
    "<select id='filterDesig'><option selected  value='notSelected'>Choose Designation</option><option>Trainee</option><option>Manager</option><option>Vice President</option><option>President</option></select>" +
    "<button class='btn' onclick='fnFilter()'>Filter</button>";

  var str =
    "<div>" +
    "<div class='showHeader' onclick='byEmpcode()'>Employee Code</div>" +
    "<div class='showHeader' onclick='byName()'>Name</div>" +
    "<div class='showHeader' onclick='byAge()'>Age</div>" +
    "<div class='showHeader' onclick='byGender()'>Gender</div>" +
    "<div class='showHeader' onclick='byDepartment()'>Department</div>" +
    "<div class='showHeader' onclick='byDesignation()'>Designation</div>" +
    "<div class='showHeader' onclick='bySalary()'>Salary</div>" +
    "<div class='showHeader'>Click to Edit</div>";
  let len = Employees.length;
  var row = "";
  for (var i = 0; i < len; i++) {
    let empcode1 = "<div class='showTable'>" + Employees[i].empcode + "</div>";
    let name1 = "<div class='showTable'>" + Employees[i].name + "</div>";
    let age1 = "<div class='showTable'>" + Employees[i].age + "</div>";
    let gender1 = "<div class='showTable'>" + Employees[i].gender + "</div>";
    let department1 =
      "<div class='showTable'>" + Employees[i].department + "</div>";
    let designation1 =
      "<div class='showTable'>" + Employees[i].designation + "</div>";
    let salary1 = "<div class='showTable'>" + Employees[i].salary + "</div>";
    let edit1 =
      "<div class='showTable'>" +
...
function edit(idx) {
  ...
  var departmentInput = document.createElement("select");
  departmentInput.innerHTML =
    "<option disabled value='notSelected'>Choose Department</option>";
  if (Employees[idx].department == "Finance")
    departmentInput.innerHTML +=
      "<option selected>Finance</option><option>Technology</option><option>Marketing</option><option>Operations</option>";
  else if (Employees[idx].department == "Technology")
    departmentInput.innerHTML +=
      "<option>Finance</option><option selected>Technology</option><option>Marketing</option><option>Operations</option>";
  else if (Employees[idx].department == "Marketing")
    departmentInput.innerHTML +=
      "<option>Finance</option><option>Technology</option><option selected>Marketing</option><option>Operations</option>";
  else if (Employees[idx].department == "Operations")
    departmentInput.innerHTML +=
      "<option>Finance</option><option>Technology</option><option>Marketing</option><option selected>Operations</option>";
  ...
  var designationInput = document.createElement("select");
  designationInput.innerHTML =
    "<option disabled value='notSelected'>Choose Designation</option>";
  if (Employees[idx].designation == "Manager")
    designationInput.innerHTML +=
      "<option>Trainee</option><option selected>Manager</option><option>Vice President</option><option>President</option>";
  else if (Employees[idx].designation == "Trainee")
    designationInput.innerHTML +=
      "<option selected>Trainee</option><option>Manager</option><option>Vice President</option><option>President</option>";
  else if (Employees[idx].designation == "Vice President")
    designationInput.innerHTML +=
      "<option>Trainee</option><option>Manager</option><option selected>Vice President</option><option>President</option>";
  else if (Employees[idx].designation == "President")
    designationInput.innerHTML +=
      "<option>Trainee</option><option>Manager</option><option>Vice President</option><option selected>President</option>";
